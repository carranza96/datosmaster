...
head(dataset)
```
Procedemos al análisis por los distintos atributos. Comenzamos con el género.
Para esto primero agrupamos todas las transacciones que pertenezcan por User_ID, para así conocer la distribución total.
...
genderDist  = ggplot(data = dataset_gender) +
                ...
                labs(title = 'Genero de los consumidores') + 
                scale_fill_brewer(palette = 'PuBuGn')
print(genderDist)
```
Como podemos observar, aproximadamente dos tercios de las compras han sido realizadas por hombres. A continuación, vamos a ver si el gasto total está relacionado con el género del consumidor.
